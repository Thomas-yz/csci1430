...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{A2:} \href{https://prateekvjoshi.com/2016/04/12/understanding-locally-connected-layers-in-convolutional-neural-networks/}{Understanding Locally Connected Layers In Convolutional Neural Networks}
...
Increases computational cost of testing & $\blacksquare$ \\
...
\midrule
Increases the nonlinearity of the decision function & $\blacksquare$ \\
