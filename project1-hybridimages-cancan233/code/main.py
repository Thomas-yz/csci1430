...
def main():
    ...
    if args.task == "filter":
        ...
        if not os.path.exists(args.image):
            ...
            if "," in args.image:
                print(
                    "You wrote a file path separated by a comma. You only need to specify "
            ...
            # if no comma used, user input path wrong
                ...
                print(
                    ...
                    + args.image
                    + " does not exist. Try running something like: "
                    "\n python3 main.py -t filter -i ../data/dog.bmp"
                )
    ...
    # if testing hybrid (part 2)
        ...
        # if both paths exist run
            ...
            print(
                "running hybrid image generation tests on images "
                + img1
                + " and "
                + img2
            )
    ...
    # user didn't specify whether testing filtering or hybrid image generation
        ...
        print(
            "You must specify what you are testing (either 'filter' or 'hybrid')"
            " for e.g. try running: \n python3 main.py -t filter -i ../data/dog.bmp"
        )
